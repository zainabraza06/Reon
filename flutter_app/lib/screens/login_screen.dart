  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle:
            GoogleFonts.inter(fontSize: 14.5, color: ReonColors.textMuted),
        prefixIcon: Icon(icon, size: 20, color: ReonColors.textMuted),
        suffixIcon: suffix,
        filled: true,
        fillColor: isDark ? ReonColors.surfaceDark : Colors.white,
        contentPadding:
        ...
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(14),
            borderSide:
                const BorderSide(color: ReonColors.primary, width: 1.5)),
      ),
    );
  }
}
...
class GradButton extends StatelessWidget {
  ...
  const GradButton(
      {super.key, required this.label, required this.loading, this.onTap});
  @override
...
class ErrorBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
      ...
      decoration: BoxDecoration(
          color: ReonColors.danger.withValues(alpha: 0.1),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
              color: isDark ? ReonColors.borderDark : ReonColors.borderLight),
          boxShadow: [
            BoxShadow(
