...
BoxDecoration gradientBubbleDecoration(
    {bool roundTL = true,
    bool roundTR = true,
    bool roundBL = true,
    bool roundBR = true}) {
...
class AppTheme {
  ...
  static TextTheme _textTheme(Color primary, Color secondary) =>
      GoogleFonts.interTextTheme().copyWith(
        displayLarge:
            GoogleFonts.inter(color: primary, fontWeight: FontWeight.w900),
        displayMedium:
            GoogleFonts.inter(color: primary, fontWeight: FontWeight.w800),
  ...
  static ThemeData get light => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          border: OutlineInputBorder(
              ...
              borderSide: const BorderSide(color: ReonColors.borderLight)),
          ...
          focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide:
                  const BorderSide(color: ReonColors.primary, width: 2)),
        ),
  ...
  static ThemeData get dark => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: const BorderSide(color: ReonColors.borderDark)),
          enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: const BorderSide(color: ReonColors.borderDark)),
          focusedBorder: OutlineInputBorder(
