...
class RecommendedUser extends ReonUser {
  ...
  RecommendedUser copyWithFlags({bool? friendRequestSent, bool? friendRequestReceived}) =>
      RecommendedUser(
        id: id, fullName: fullName, email: email, username: username,
        profilePic: profilePic, bio: bio, location: location, nativeLanguage: nativeLanguage,
        isOnboarded: isOnboarded, isOnline: isOnline,
        mutualFriendsCount: mutualFriendsCount,
        friendRequestSent: friendRequestSent ?? this.friendRequestSent,
        friendRequestReceived: friendRequestReceived ?? this.friendRequestReceived,
      );
}
