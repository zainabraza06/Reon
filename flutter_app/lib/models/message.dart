...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> j) => ChatMessage(
    id:             j['_id'] as String,
    sender:         j['sender'] is Map ? (j['sender'] as Map)['_id'] as String : j['sender'] as String,
    receiver:       j['receiver'] is Map ? (j['receiver'] as Map)['_id'] as String : j['receiver'] as String,
    ciphertext:     j['ciphertext'] as String?,
    encryptedKey:   j['encryptedKey'] as String?,
    contentType:    j['contentType'] as String? ?? 'text',
    media:          (j['media'] as List? ?? []).map((m) => MediaFile.fromJson(m as Map<String, dynamic>)).toList(),
  ...
  ChatMessage copyWith({String? plaintext, String? status, bool? delivered, DateTime? deliveredAt, bool? read, DateTime? readAt}) => ChatMessage(
    id: id, sender: sender, receiver: receiver,
    ciphertext: ciphertext, encryptedKey: encryptedKey,
    contentType: contentType, media: media, sentAt: sentAt,
    isVoiceMessage: isVoiceMessage, tempId: tempId,
